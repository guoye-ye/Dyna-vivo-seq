...
#cd ${tsv_dir}
perl /home/disk/lfh/pipeline/drop-seq/scripts/background_correction.pl -bg ${tsv_dir2}/${control}_both_strand_all_TC.tsv_q27.tsv -in ${tsv_dir}/${sample}_both_strand_all_TC.tsv_q27.tsv

############ 2. Add mutation information back to bam files
perl /home/disk/lfh/pipeline/drop-seq/scripts/TagIntronicRead_V5.pl -read ${sample}_both_strand_all_TC.tsv_q27.tsv_corrected.tsv -bam ${bam_dir}/${sample}_star_gene_exon_tagged_TagIntronic_clean.bam
